...
class Board {
    constructor(element1, boardId){
        ...
        this.draw = ()=>{
            ...
            for (const obj of this.objects)this.drawObject(obj);
            if (this.currentDrawingObject) this.drawObject(this.currentDrawingObject);
        };
        this.drawObject = (obj)=>{
            if (obj.type === "path") this.drawPath(obj);
        };
        this.drawPath = (obj)=>{
...
},{}]},["7Llx6","7PGg5"], "7PGg5", "parcelRequire2d1f")
